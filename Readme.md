...
To-Do is an application that helps you keep track of all your tasks. Programmed in Java and compatible with MacOs, Linux, and Windows! For full project including, issues, board, wiki etc. check out the project on GitLab: https://gitlab.stud.idi.ntnu.no/eivisha/to-do-list
